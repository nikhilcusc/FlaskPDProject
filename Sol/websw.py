...
17-04-12, 16-04-12]
    ...
    return render_template('linechart.html',temperature= temperature,consumption= consumption, time= time, title='chart',labels= labels, values= values, values2= values2)
